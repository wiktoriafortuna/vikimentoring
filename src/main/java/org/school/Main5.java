...
public class Main5 {
    public static void main(String[] args) {
        ...
        if (isTeacherAvailable1 == true) {
            Teacher drWiktoria = school1.findTeacherByName("Dr Wiktoria");
            if (drWiktoria != null) {
                System.out.println(drWiktoria);
            }
        }

        Teacher drWiktoria = school1.findTeacherByName("na pewno nie ma takiego nauczyciel");
        if(drWiktoria == null) {
            System.out.println(drWiktoria + " jest null");
        }
